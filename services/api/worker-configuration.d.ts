/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 421279aac7544242691cf39a29ac2f67)
// Runtime types generated with workerd@1.20260831.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "production";
	ALLOWED_ORIGINS: "http://localhost:5173,http://localhost:5174,https://seigyo.cord-pail.workers.dev,https://myshop.cord-pail.workers.dev";
	OPERATIONS_STATE: DurableObjectNamespace<import("./src/index").OperationsStateObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OperationsStateObject";
	}
