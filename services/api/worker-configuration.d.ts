/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cd7b8d8158a631cc9ff08a0c8e98748c)
// Runtime types generated with workerd@1.20260831.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "production-simulation";
	ALLOWED_ORIGINS: "http://localhost:5173,http://localhost:5174,https://seigyo.destiny-scooter.workers.dev,https://myshop.destiny-scooter.workers.dev";
	SIMULATION: DurableObjectNamespace<import("./src/index").SimulationStateObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SimulationStateObject";
	}
