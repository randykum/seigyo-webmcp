...
export interface Execution { id: string; proposalId: string; incidentId: string; state: "queued" | "running" | "succeeded" | "failed"; action: RecoveryAction; startedAt: number; finishedAt?: number; beforeStateHash: string; afterStateHash?: string; undoAvailable: boolean; causalRevision: number; }
